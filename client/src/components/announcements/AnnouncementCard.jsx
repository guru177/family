  ...
  return (
    ...
    >
      ...
      <div className="p-8 md:p-10 flex flex-col flex-grow">
        ...
        <h3 className="text-2xl md:text-3xl font-heading font-extrabold text-[#050505] mb-4 leading-snug group-hover:text-[#146c43] transition-colors line-clamp-2">
          {news.title}
        </h3>
